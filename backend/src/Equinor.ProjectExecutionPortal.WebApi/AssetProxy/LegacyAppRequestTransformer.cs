...
{
    public class LegacyAppRequestTransformer : HttpTransformer
    {
        private readonly ITokenAcquisition _tokenAcquisition;
        private readonly AssetProxyOptions _options;

        public LegacyAppRequestTransformer(ITokenAcquisition tokenAcquisition, IOptions<AssetProxyOptions> options)
        {
        ...
        public override async ValueTask TransformRequestAsync(HttpContext httpContext, HttpRequestMessage proxyRequest, string destinationPrefix)
        {
            ...
            proxyRequest.RequestUri = RequestUtilities.MakeDestinationAddress(_options.FusionPortalUrl!, $"/bundles/apps/{key}.js", queryContext.QueryString);
