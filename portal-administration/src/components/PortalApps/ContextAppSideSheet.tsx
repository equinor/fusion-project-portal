...
import { OnboardedContextsTable } from "../OnboardedContexts/OnboradedContextsTable";
...
export function ContextAppSideSheet({
  ...
  const { isLoading, activeContexts, contextTypes } =
    useActiveOnboardedContext();
  const [contexts, setSelectedContexts] = useState<
    OnboardedContext[] | undefined
  >();
