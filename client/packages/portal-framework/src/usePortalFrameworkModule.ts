...
import { usePortalFramework } from './usePortalFramework';
 ...
 */
export const usePortalFrameworkModule = <
...
>(
	...
	const framework = usePortalFramework();
	// TODO
	// eslint-disable-next-line @typescript-eslint/ban-ts-comment
	// @ts-ignore
	const module = framework.modules[name];
	if (!module) {
		console.warn(`the requested module [${module}] is not included in the portal framework instance`);
	}
	return module;
};
