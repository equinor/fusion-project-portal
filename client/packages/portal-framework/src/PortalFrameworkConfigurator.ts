...
import http, { configureHttpClient, configureHttp, HttpClientOptions } from '@equinor/fusion-framework-module-http';
...
import { FusionPortalModules } from './types';
 ...
 */
export class PortalFrameworkConfigurator<
	TModules extends Array<AnyModule> = [],
	// eslint-disable-next-line @typescript-eslint/no-explicit-any
	TRef = any
> extends ModulesConfigurator<FusionPortalModules<TModules>, TRef> {
	constructor() {
		super([event, auth, http, disco, services]);
...
export default PortalFrameworkConfigurator;
