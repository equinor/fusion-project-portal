...
export async function getPimsTasks(client: IHttpClient, signal?: AbortSignal): Promise<FusionTask[]> {
...
export async function getProCoSysAssignments(client: IHttpClient, signal?: AbortSignal): Promise<FusionTask[]> {
