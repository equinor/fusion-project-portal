module.exports = /******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    ...
    /***/ 715: /***/ function (
      ...
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.createChangesetByType =
        exports.parseBodyForChangeType =
        exports.parseBody =
          void 0;
    ...
    `;
      ...
      const createChangesetByType = (changeSet, type) => {
        ...
        return formatChangeSet(
          type === "none" ? getEmptySet() : header + changeSet
        );
      };
      ...
      async function run() {
        try {
          ...
          const event = JSON.parse(
            await readFile(eventPath, { encoding: "utf8" })
          );
          const { body, id, number } = event.pull_request;
          core.setOutput("event", JSON.stringify(event.pull_request));
          ...
          const changeSet = (0, changeset_1.createChangesetByType)(
            releaseNote,
            type
          );
    ...
    /***/ 314: /***/ function (
      ...
      const fs_1 = __importDefault(__nccwpck_require__(747));
      const util_1 = __importDefault(__nccwpck_require__(669));
      const createDir = util_1.default.promisify(fs_1.default.mkdir);
      /**
       ...
       */
      const createChangesetPath = async (workspacePath) => {
        const directory = path_1.default.join(workspacePath, ".changeset");
